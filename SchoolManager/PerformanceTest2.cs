...
namespace SchoolManager
{
    static class PerformanceTest2
    {
        ...
        private static Group _12b()
        {
            ...
            Group g = new Group(4, "12a", dayLims, weekLims, subject2Teacher);
        ...
        private static SuperGroup _vtoriEzik12BV()
        {
            ...
            SuperGroup sg = new SuperGroup("vtori12A", currGroups, currTeachers, 2, requiredMultilessons);
