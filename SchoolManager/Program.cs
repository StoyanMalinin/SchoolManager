...
namespace SchoolManager
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ScheduleGenerator4 sg = new ScheduleGenerator4(groups, PerformanceTest1.teachers, PerformanceTest1.subjects, 
                                                           PerformanceTest1.higharchy, multilessons, superGroups);//за общи проблеми
